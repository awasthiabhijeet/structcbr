...
local dataset_reader_name = "pickle_reader";
// local dataset_reader_name = "spider_with_eos";
...

{
  ...
  "train_data_path": "processed_data/train.pkl",
  "validation_data_path": "processed_data/val.pkl",
