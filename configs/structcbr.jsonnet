...
local train_data_path = "processed_data/train.pkl";
local validation_data_path = "processed_data/val.pkl";
local train_nbrs_path = "processed_data/same_db_train_nbrs.pkl";
local val_nbrs_path = "processed_data/same_db_val_nbrs.pkl";
local batches_per_epoch = 100*setting.grad_acum;
...

{
  ...
  "model": {
    ...
    "type": "tx_cbr_improved_entire_frontier",
  ...
  "data_loader": {
     "type": dataset_reader_name,
     // "batches_per_epoch":std.floor(stringToInt("train_size")/8),
  ...
  "validation_data_loader": {
    "type": dataset_reader_name,
    "batch_size" : 4*setting.batch_size,
    "shuffle": true,
  },
  "trainer": {
    "type": "finetuner",
    "pretrained_ckpt": "train_ckpts/smbop_base/best.th",
