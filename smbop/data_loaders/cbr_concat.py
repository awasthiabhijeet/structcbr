...
@DataLoader.register("cbr_concat")
class CBRConcat(MultiProcessDataLoader):
    def __init__(
        self,
        ...
        *,
        ...
        self.tokenized_gold_sqls=[self.reader._tokenizer.tokenize(q+' [SEP] [SEP]') for q in self.gold_sqls]
